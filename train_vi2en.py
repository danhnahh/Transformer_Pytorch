...
# ============================================================
# LOAD DATA - CHIỀU VI -> EN
# ============================================================
print("=" * 60)
print("LOADING DATA: VI -> EN")
print("=" * 60)

# Load real data
real_data = get_tokenized_data('train_filtered', direction="vi2en")
...
# ============================================================
print("=" * 60)
print("STARTING TRAINING: VI -> EN")
print("=" * 60)

training_args = Seq2SeqTrainingArguments(
    output_dir="./nllb-vi2en",
...
# Save LoRA adapter
model.save_pretrained("./nllb-vi2en/lora")
tokenizer.save_pretrained("./nllb-vi2en/lora")

print("=" * 60)
print("DONE! LoRA adapter saved at: ./nllb-vi2en/lora")
print("=" * 60)
